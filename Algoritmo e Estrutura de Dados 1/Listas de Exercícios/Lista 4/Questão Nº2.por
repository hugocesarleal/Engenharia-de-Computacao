programa
{
	...
	funcao inicio()
	{
		...
		escreva("\nInforme qual a posição do número que deseja saber: ")
		leia(info)

		se(vetNum[info-1]==0)
		{
			escreva("Nenhum valor válido foi inserido na posição ",info)

		}
		senao
			escreva("O número que está na posição ",info," é: ",vetNum[info-1])
	}
}
/* $$$ Portugol Studio $$$ 
 * 
